          ...
          <div className='inline-flex flex-col gap-2 items-start'>
            ...
            <div className='flex items-center justify-center sm:justify-initial is-full gap-4 flex-wrap sm:flex-nowrap'>
              ...
              <div className='flex items-center gap-1'>
                <CustomIconButton className='rounded-lg text-white bg-[#4267b2]'>
                  <i className='ri-facebook-circle-line' />
                </CustomIconButton>
                <CustomIconButton className='rounded-lg text-white bg-[#1da1f2]'>
                  <i className='ri-twitter-line' />
                </CustomIconButton>
                <CustomIconButton className='rounded-lg text-white bg-[#007bb6]'>
